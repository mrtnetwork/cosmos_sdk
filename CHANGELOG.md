## 4.1.0
- Fix thornode parsing provider models.

## 4.0.0

### ⚠️ Breaking Changes

- **All protobuf models are now generated by the `onchain_proto` package.**
- Generated class names have changed to follow the new generator.
- Generated file locations and import paths have changed.
- Existing projects must update protobuf imports after upgrading to v4.

### Added

- Switched to the new `onchain_proto` code generator.
- Improved protobuf code generation.
- Better compatibility with Cosmos SDK and Cosmos EVM protobuf definitions.
- Support for generating Dart models from custom Cosmos SDK `.proto` files.

### Changed

- Reorganized generated protobuf source files.
- Improved generated model consistency and naming.
- Updated documentation and examples.
- Reduced maintenance by using a dedicated protobuf generator package.
