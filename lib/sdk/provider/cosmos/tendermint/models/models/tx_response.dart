...
// import 'package:cosmos_sdk/sdk/provider/cosmos/tendermint/models/models/check_tx.dart';
// import 'package:cosmos_sdk/sdk/provider/cosmos/tendermint/models/models/deliver_tx_response.dart';
...
//         Map<String, dynamic>.from(json["deliver_tx"] ?? json["tx_result"] ?? {}),
//       ),
//     );
//   }
...
//   bool get isSuccess => height > BigInt.zero && checkTx.code == 0 && deliverTx.code == 0;
