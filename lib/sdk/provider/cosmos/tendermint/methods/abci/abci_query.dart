...
class TendermintRequestBroadcastAbciQuery
  ...
  factory TendermintRequestBroadcastAbciQuery.fromQueryRequest({
    required ICosmosProtoQueryMessage request,
    int? height,
    bool? prove,
  }) {
  ...
  @override
  TendermintABCIQueryResponseResult onResonse(Map<String, dynamic> result) {
    return TendermintABCIQueryResponseResult.fromJson(result);
  }
}
