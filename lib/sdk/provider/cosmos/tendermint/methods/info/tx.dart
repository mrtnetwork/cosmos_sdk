...
class TendermintRequestTx
    extends
        TendermintRequest<TendermintTxResponseResult, Map<String, dynamic>> {
  ...
  @override
  TendermintTxResponseResult onResonse(Map<String, dynamic> result) {
    return TendermintTxResponseResult.fromJson(result);
  }
}
