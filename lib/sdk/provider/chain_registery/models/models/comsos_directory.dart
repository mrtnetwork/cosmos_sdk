...
class CosmosDirectoryChain {
  ...
  factory CosmosDirectoryChain.fromJson(Map<String, dynamic> json) {
    return CosmosDirectoryChain(
      ...
      networkType: json.valueAs("network_type"),
      ...
      explorers:
          json
              .valueAsList<List<Map<String, dynamic>>?>("explorers")
              ?.map(CCRExplorer.fromJson)
              .toList() ??
          [],
      keywords: json.valueAsList<List<String>?>("keywords"),
      bestApis: CCRApis.fromJson(
        json.valueEnsureAsMap<String, dynamic>("best_apis"),
      ),
      assets:
          json
