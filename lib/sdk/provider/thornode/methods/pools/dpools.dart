...
import 'package:cosmos_sdk/sdk/provider/thornode/models/models/derived_asset_information.dart';

/// Returns the pool information for all derived assets.
class ThorNodeRequestDerivedPools
    extends
        ThorNodeRequestParam<
          List<DerivedAssetPoolInformationResponse>,
