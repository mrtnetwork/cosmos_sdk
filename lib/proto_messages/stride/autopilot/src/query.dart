...
import "package:cosmos_sdk/proto_messages/stride/autopilot/src/params.dart"
    as stride_autopilot_params;
...
class QueryParamsRequest extends CosmosProtoMessage
    ...
    return ProtoMessageConfig(
      ...
      options: [
        ProtoOptionHttp(
          ...
          path: "/Stride-Labs/stride/autopilot/params",
        ),
      ],
      fields: [],
    );
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.strideAutopilotQueryParamsRequest;
  @override
...
class QueryParamsResponse extends CosmosProtoMessage {
  ...
  final stride_autopilot_params.Params? params;
  ...
  factory QueryParamsResponse.fromJson(Map<String, dynamic> json) {
    return QueryParamsResponse(
      params: json
          .valueTo<stride_autopilot_params.Params?, Map<String, dynamic>>(
            key: 'params',
            parse: (v) => stride_autopilot_params.Params.fromJson(v),
  ...
  factory QueryParamsResponse.deserialize(List<int> bytes) {
    ...
    return QueryParamsResponse(
      params: decode.messageTo<stride_autopilot_params.Params?>(
        1,
        (b) => stride_autopilot_params.Params.deserialize(b),
      ),
    );
  }
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.strideAutopilotQueryParamsResponse;
}
