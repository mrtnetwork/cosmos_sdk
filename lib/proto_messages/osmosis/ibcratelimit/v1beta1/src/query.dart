...
import "package:cosmos_sdk/proto_messages/osmosis/ibcratelimit/v1beta1/src/params.dart"
    as osmosis_ibcratelimit_v1beta1_params;
...
class ParamsRequest extends CosmosProtoMessage
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.osmosisIbcratelimitV1beta1ParamsRequest;
  @override
...
class ParamsResponse extends CosmosProtoMessage {
  ...
  final osmosis_ibcratelimit_v1beta1_params.Params? params;
  ...
  factory ParamsResponse.fromJson(Map<String, dynamic> json) {
    return ParamsResponse(
      params: json.valueTo<
        osmosis_ibcratelimit_v1beta1_params.Params?,
        Map<String, dynamic>
      >(
        key: 'params',
        parse: (v) => osmosis_ibcratelimit_v1beta1_params.Params.fromJson(v),
  ...
  factory ParamsResponse.deserialize(List<int> bytes) {
    ...
    return ParamsResponse(
      params: decode.messageTo<osmosis_ibcratelimit_v1beta1_params.Params?>(
        1,
        (b) => osmosis_ibcratelimit_v1beta1_params.Params.deserialize(b),
      ),
    );
  }
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.osmosisIbcratelimitV1beta1ParamsResponse;
}
