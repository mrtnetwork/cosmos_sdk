...
class MsgUpdateParams extends CosmosProtoMessage
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ...
        ProtoOptionString(
          name: "amino.name",
          value: "cosmos-sdk/x/auth/MsgUpdateParams",
        ),
      ],
      fields: [
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosAuthV1beta1MsgUpdateParams;
  @override
...
class MsgUpdateParamsResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosAuthV1beta1MsgUpdateParamsResponse;
}
