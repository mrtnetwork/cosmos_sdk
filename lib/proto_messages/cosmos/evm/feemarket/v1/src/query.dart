...
import "package:cosmos_sdk/proto_messages/cosmos/evm/feemarket/v1/src/feemarket.dart"
    as cosmos_evm_feemarket_v1_feemarket;
...
class QueryParamsRequest extends CosmosProtoMessage
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1QueryParamsRequest;
  @override
...
class QueryParamsResponse extends CosmosProtoMessage {
  ...
  final cosmos_evm_feemarket_v1_feemarket.Params? params;
  ...
  factory QueryParamsResponse.fromJson(Map<String, dynamic> json) {
    return QueryParamsResponse(
      params: json.valueTo<
        cosmos_evm_feemarket_v1_feemarket.Params?,
        Map<String, dynamic>
      >(
        key: 'params',
        parse: (v) => cosmos_evm_feemarket_v1_feemarket.Params.fromJson(v),
  ...
  factory QueryParamsResponse.deserialize(List<int> bytes) {
    ...
    return QueryParamsResponse(
      params: decode.messageTo<cosmos_evm_feemarket_v1_feemarket.Params?>(
        1,
        (b) => cosmos_evm_feemarket_v1_feemarket.Params.deserialize(b),
      ),
    );
  }
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1QueryParamsResponse;
}
...
class QueryBaseFeeRequest extends CosmosProtoMessage
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1QueryBaseFeeRequest;
  @override
...
class QueryBaseFeeResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1QueryBaseFeeResponse;
}
...
class QueryBlockGasRequest extends CosmosProtoMessage
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1QueryBlockGasRequest;
  @override
...
class QueryBlockGasResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1QueryBlockGasResponse;
}
