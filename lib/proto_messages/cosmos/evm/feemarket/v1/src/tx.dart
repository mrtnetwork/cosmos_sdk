...
class MsgUpdateParams extends CosmosProtoMessage
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ...
        ProtoOptionString(
          name: "amino.name",
          value: "cosmos/evm/x/feemarket/MsgUpdateParams",
        ),
      ],
      fields: [
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1MsgUpdateParams;
  @override
...
class MsgUpdateParamsResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmFeemarketV1MsgUpdateParamsResponse;
}
