...
import "package:cosmos_sdk/proto_messages/cosmos/evm/erc20/v1/src/erc20.dart"
    as cosmos_evm_erc20_v1_erc20;
...
class QueryTokenPairsRequest extends CosmosProtoMessage
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmErc20V1QueryTokenPairsRequest;
  @override
...
class QueryTokenPairsResponse extends CosmosProtoMessage {
  ...
  final List<cosmos_evm_erc20_v1_erc20.TokenPair> tokenPairs;
          ...
          (json.valueEnsureAsList<dynamic>(
              ...
              .map(
                (e) => JsonParser.valueTo<
                  cosmos_evm_erc20_v1_erc20.TokenPair,
                  Map<String, dynamic>
                >(
                  value: e,
                  parse: (v) => cosmos_evm_erc20_v1_erc20.TokenPair.fromJson(v),
                ),
              )
              .toList(),
      pagination: json.valueTo<
  ...
  factory QueryTokenPairsResponse.deserialize(List<int> bytes) {
    ...
    return QueryTokenPairsResponse(
      tokenPairs:
          decode
              .getListOfBytes(1)
              .map((b) => cosmos_evm_erc20_v1_erc20.TokenPair.deserialize(b))
              .toList(),
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmErc20V1QueryTokenPairsResponse;
}
...
class QueryTokenPairRequest extends CosmosProtoMessage
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmErc20V1QueryTokenPairRequest;
  @override
...
class QueryTokenPairResponse extends CosmosProtoMessage {
  ...
  /// module
  final cosmos_evm_erc20_v1_erc20.TokenPair? tokenPair;
  ...
  factory QueryTokenPairResponse.fromJson(Map<String, dynamic> json) {
    return QueryTokenPairResponse(
      tokenPair: json
          .valueTo<cosmos_evm_erc20_v1_erc20.TokenPair?, Map<String, dynamic>>(
            key: 'token_pair',
            parse: (v) => cosmos_evm_erc20_v1_erc20.TokenPair.fromJson(v),
            acceptCamelCase: true,
          ),
  ...
  factory QueryTokenPairResponse.deserialize(List<int> bytes) {
    final decode = CosmosProtoMessage.decode(bytes, protoConfigStatic());
    return QueryTokenPairResponse(
      tokenPair: decode.messageTo<cosmos_evm_erc20_v1_erc20.TokenPair?>(
        1,
        (b) => cosmos_evm_erc20_v1_erc20.TokenPair.deserialize(b),
      ),
    );
  }
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmErc20V1QueryTokenPairResponse;
}
...
class QueryParamsRequest extends CosmosProtoMessage
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmErc20V1QueryParamsRequest;
  @override
...
class QueryParamsResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosEvmErc20V1QueryParamsResponse;
}
