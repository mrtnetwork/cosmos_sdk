...
class MsgUpdateParams extends CosmosProtoMessage
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ...
        ProtoOptionString(
          name: "amino.name",
          value: "cosmos-sdk/x/mint/MsgUpdateParams",
        ),
      ],
      fields: [
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosMintV1beta1MsgUpdateParams;
  @override
...
class MsgUpdateParamsResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosMintV1beta1MsgUpdateParamsResponse;
}
