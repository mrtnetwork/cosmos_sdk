...
class HistoricalInfo extends CosmosProtoMessage {
  final tendermint_types_types.Header? header;

  final List<Validator> valset;

  const HistoricalInfo({this.header, this.valset = const []});
  ...
  @override
  List<Object?> get protoValues => [header, valset];

  @override
  Map<String, dynamic> toJson() {
    return {
      'header': header?.toJson(),
      'valset': valset.map((e) => e.toJson()).toList(),
    };
  }
  ...
  factory HistoricalInfo.fromJson(Map<String, dynamic> json) {
    return HistoricalInfo(
      ...
      valset:
          (json.valueEnsureAsList<dynamic>('valset', acceptCamelCase: true))
              .map(
  ...
  factory HistoricalInfo.deserialize(List<int> bytes) {
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1HistoricalInfo;
}
...
class CommissionRates extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1CommissionRates;
}
...
class Commission extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Commission;
}
...
class Description extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Description;
}
...
class Validator extends CosmosProtoMessage {
  ...
  factory Validator.fromJson(Map<String, dynamic> json) {
    return Validator(
      ...
      delegatorShares: json.valueAsString<String?>(
        'delegator_shares',
        acceptCamelCase: true,
      ),
  ...
  factory Validator.deserialize(List<int> bytes) {
    ...
    return Validator(
      ...
      delegatorShares: decode.getString<String?>(6),
      ...
      minSelfDelegation: decode.getString<String?>(11),
      unbondingOnHoldRefCount: decode.getBigInt<BigInt?>(12),
      unbondingIds: decode.getListOrEmpty<BigInt>(13),
    );
  }

  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Validator;
}
...
class Delegation extends CosmosProtoMessage {
  ...
  const Delegation({this.delegatorAddress, this.validatorAddress, this.shares});
  ...
  factory Delegation.fromJson(Map<String, dynamic> json) {
    return Delegation(
      ...
      shares: json.valueAsString<String?>('shares', acceptCamelCase: true),
    );
  }
  ...
  factory Delegation.deserialize(List<int> bytes) {
    ...
    return Delegation(
      ...
      shares: decode.getString<String?>(3),
    );
  }

  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Delegation;
}
...
class UnbondingDelegation extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1UnbondingDelegation;
}
...
class UnbondingDelegationEntry extends CosmosProtoMessage {
  ...
  factory UnbondingDelegationEntry.fromJson(Map<String, dynamic> json) {
    return UnbondingDelegationEntry(
      ...
      initialBalance: json.valueAsString<String?>(
        'initial_balance',
        acceptCamelCase: true,
      ),
  ...
  factory UnbondingDelegationEntry.deserialize(List<int> bytes) {
    ...
    return UnbondingDelegationEntry(
      ...
      initialBalance: decode.getString<String?>(3),
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1UnbondingDelegationEntry;
}
...
class RedelegationEntry extends CosmosProtoMessage {
  ...
  factory RedelegationEntry.fromJson(Map<String, dynamic> json) {
    return RedelegationEntry(
      ...
      sharesDst: json.valueAsString<String?>(
        'shares_dst',
        acceptCamelCase: true,
      ),
      unbondingId: json.valueAsBigInt<BigInt?>(
  ...
  factory RedelegationEntry.deserialize(List<int> bytes) {
    ...
    return RedelegationEntry(
      ...
      initialBalance: decode.getString<String?>(3),
      sharesDst: decode.getString<String?>(4),
      unbondingId: decode.getBigInt<BigInt?>(5),
      unbondingOnHoldRefCount: decode.getBigInt<BigInt?>(6),
    );
  }
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1RedelegationEntry;
}
...
class Redelegation extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Redelegation;
}
...
class Params extends CosmosProtoMessage {
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ProtoOptionString(
          name: "amino.name",
          value: "cosmos-sdk/x/staking/Params",
        ),
      ],
      fields: [
        ProtoFieldConfig.message(
  ...
  factory Params.deserialize(List<int> bytes) {
    ...
    return Params(
      ...
      bondDenom: decode.getString<String?>(5),
      minCommissionRate: decode.getString<String?>(6),
    );
  }

  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Params;
}
...
class DelegationResponse extends CosmosProtoMessage {
  ...
  const DelegationResponse({this.delegation, this.balance});
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1DelegationResponse;
}
...
class RedelegationEntryResponse extends CosmosProtoMessage {
  ...
  const RedelegationEntryResponse({this.redelegationEntry, this.balance});
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1RedelegationEntryResponse;
}
...
class RedelegationResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1RedelegationResponse;
}
...
class Pool extends CosmosProtoMessage {
  ...
  const Pool({this.notBondedTokens, this.bondedTokens});
  ...
  @override
  List<Object?> get protoValues => [notBondedTokens, bondedTokens];
  ...
  factory Pool.fromJson(Map<String, dynamic> json) {
    return Pool(
      notBondedTokens: json.valueAsString<String?>(
        'not_bonded_tokens',
        acceptCamelCase: true,
      ),
      bondedTokens: json.valueAsString<String?>(
        'bonded_tokens',
        acceptCamelCase: true,
      ),
    );
  ...
  factory Pool.deserialize(List<int> bytes) {
    final decode = CosmosProtoMessage.decode(bytes, protoConfigStatic());
    return Pool(
      notBondedTokens: decode.getString<String?>(1),
      bondedTokens: decode.getString<String?>(2),
    );
  }

  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.cosmosStakingV1beta1Pool;
}
