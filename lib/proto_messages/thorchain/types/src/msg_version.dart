...
class MsgSetVersion extends CosmosProtoMessage
    with
  ...
  const MsgSetVersion({this.version, this.signer});
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ProtoOptionString(name: "amino.name", value: "thorchain/MsgSetVersion"),
      ],
      fields: [
  ...
  @override
  List<Object?> get protoValues => [version, signer];
  ...
  factory MsgSetVersion.fromJson(Map<String, dynamic> json) {
  ...
  factory MsgSetVersion.deserialize(List<int> bytes) {
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.typesMsgSetVersion;
  @override
