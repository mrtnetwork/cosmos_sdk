...
class MsgNodePauseChain extends CosmosProtoMessage
    with
  ...
  const MsgNodePauseChain({this.value, this.signer});
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ProtoOptionString(
          name: "amino.name",
          value: "thorchain/MsgNodePauseChain",
        ),
      ],
      fields: [
  ...
  @override
  List<Object?> get protoValues => [value, signer];
  ...
  factory MsgNodePauseChain.fromJson(Map<String, dynamic> json) {
  ...
  factory MsgNodePauseChain.deserialize(List<int> bytes) {
    final decode = CosmosProtoMessage.decode(bytes, protoConfigStatic());
    return MsgNodePauseChain(
      value: decode.getBigInt<BigInt?>(1),
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.typesMsgNodePauseChain;
  @override
