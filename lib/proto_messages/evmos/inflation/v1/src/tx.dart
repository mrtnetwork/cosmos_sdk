...
class MsgUpdateParams extends CosmosProtoMessage
  ...
  static ProtoMessageConfig protoConfigStatic() {
    return ProtoMessageConfig(
      ...
      options: [
        ProtoOptionString(
          name: "amino.name",
          value: "evmos/x/inflation/MsgUpdateParams",
        ),
  ...
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.evmosInflationV1MsgUpdateParams;
  @override
...
class MsgUpdateParamsResponse extends CosmosProtoMessage {
  ...
  @override
  DefaultCosmosProtoTypeUrl get declarationId =>
      DefaultCosmosProtoTypeUrl.evmosInflationV1MsgUpdateParamsResponse;
}
