...
class EthermintTypesV1ExtensionOptionsWeb3Tx extends CosmosMessage {
  ...
  const EthermintTypesV1ExtensionOptionsWeb3Tx(
      {required this.typedDataChainId,
      required this.feePayer,
      required this.feePayerSig});
  factory EthermintTypesV1ExtensionOptionsWeb3Tx.deserialize(List<int> bytes) {
    final decode = CosmosProtocolBuffer.decode(bytes);
    return EthermintTypesV1ExtensionOptionsWeb3Tx(
  ...
  @override
  TypeUrl get typeUrl => EthermintTypesV1Types.extensionOptionsWeb3Tx;
