...
class EVMV1TxResult extends CosmosMessage {
  ...
  // logs.
  final EVMV1TransactionLogs txLogs;
  ...
  factory EVMV1TxResult.deserialize(List<int> bytes) {
    final decode = CosmosProtocolBuffer.decode(bytes);
    return EVMV1TxResult(
        contractAddress: decode.getField(1),
        bloom: decode.getField(2),
        txLogs: EVMV1TransactionLogs.deserialize(decode.getField(3)),
  ...
  @override
  TypeUrl get typeUrl => EvmV1Types.txResult;
