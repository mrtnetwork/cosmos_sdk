...
abstract class BankV1Beta1Service<T extends CosmosMessage>
  ...
  static T? fromJson<T extends BankV1Beta1Service>(
    ...
    final BankV1Beta1Service? service = switch (type) {
      ...
      BankV1beta1Types.msgSetSendEnabled => MsgSetSendEnabled.fromJson(json),
      BankV1beta1Types.msgUpdateParams => BankMsgUpdateParams.fromJson(json),
      _ => null
    } as BankV1Beta1Service?;
    if (service == null) return null;
    if (service is! T) {
      throw DartCosmosSdkPluginException("Invalid BankV1Beta1 Service.",
          details: {
            "excepted": "$T",
