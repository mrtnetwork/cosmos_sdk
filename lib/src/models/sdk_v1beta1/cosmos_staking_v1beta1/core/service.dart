...
abstract class StakingV1Beta1Service<T extends CosmosMessage>
  ...
  static T? fromJson<T extends StakingV1Beta1Service>(
    ...
    final StakingV1Beta1Service? service = switch (type) {
      ...
      StakingV1beta1Types.msgEditValidator => MsgEditValidator.fromJson(json),
      ...
      StakingV1beta1Types.msgTokenizeShares => MsgTokenizeShares.fromJson(json),
    ...
    if (service is! T) {
      throw DartCosmosSdkPluginException("Invalid StakingV1Beta1 Service.",
          details: {
            "excepted": "$T",
  ...
  static T? deserialize<T extends StakingV1Beta1Service>(
    ...
    final StakingV1Beta1Service? service = switch (type) {
      ...
      StakingV1beta1Types.msgUndelegate => MsgUndelegate.deserialize(bytes),
      StakingV1beta1Types.stakingMsgUpdateParams =>
