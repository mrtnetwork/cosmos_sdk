...
abstract class OsmosisValidatorPreferenceV1Beta1<T extends CosmosMessage>
  ...
  static T? fromJson<T extends OsmosisValidatorPreferenceV1Beta1>(
    ...
    final OsmosisValidatorPreferenceV1Beta1? service = switch (type) {
      OsmosisValidatorPreferenceV1beta1Types.msgDelegateToValidatorSet =>
        OsmosisValidatorPreferenceMsgDelegateToValidatorSet.fromJson(json),
      OsmosisValidatorPreferenceV1beta1Types.msgSetValidatorSetPreference =>
        OsmosisValidatorPreferenceMsgSetValidatorSetPreference.fromJson(json),
      OsmosisValidatorPreferenceV1beta1Types.msgUndelegateFromValidatorSet =>
        OsmosisValidatorPreferenceMsgUndelegateFromValidatorSet.fromJson(json),
      OsmosisValidatorPreferenceV1beta1Types.msgWithdrawDelegationRewards =>
        OsmosisValidatorPreferenceMsgWithdrawDelegationRewards.fromJson(json),
      _ => null
  ...
  static T? deserialize<T extends OsmosisValidatorPreferenceV1Beta1>(
    ...
    final OsmosisValidatorPreferenceV1Beta1? service = switch (type) {
      OsmosisValidatorPreferenceV1beta1Types.msgDelegateToValidatorSet =>
        OsmosisValidatorPreferenceMsgDelegateToValidatorSet.deserialize(bytes),
      OsmosisValidatorPreferenceV1beta1Types.msgSetValidatorSetPreference =>
