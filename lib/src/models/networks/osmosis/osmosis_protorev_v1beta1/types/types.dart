...
class OsmosisProtorevV1beta1Types extends TypeUrl {
  ...
  @override
  final String? rpc;
  const OsmosisProtorevV1beta1Types._(this.typeUrl, {this.rpc});
