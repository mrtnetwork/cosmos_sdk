...
class OsmosisLockupTypes extends TypeUrl {
  ...
  static const OsmosisLockupTypes periodLock = OsmosisLockupTypes._(
    "/osmosis.lockup.PeriodLock",
  );
  static const OsmosisLockupTypes syntheticLock = OsmosisLockupTypes._(
    "/osmosis.lockup.SyntheticLock",
  );

  static const OsmosisLockupTypes queryCondition = OsmosisLockupTypes._(
    "/osmosis.lockup.QueryCondition",
  );
  static const OsmosisLockupTypes genesisState = OsmosisLockupTypes._(
    "/osmosis.lockup.GenesisState",
  );

  static const OsmosisLockupTypes msgLockTokens = OsmosisLockupTypes._(
    "/osmosis.lockup.MsgLockTokens",
  );
  static const OsmosisLockupTypes msgLockTokensResponse = OsmosisLockupTypes._(
    "/osmosis.lockup.MsgLockTokensResponse",
  );

  static const OsmosisLockupTypes msgBeginUnlockingAll = OsmosisLockupTypes._(
  ...
  static const OsmosisLockupTypes msgBeginUnlocking = OsmosisLockupTypes._(
  ...
  static const OsmosisLockupTypes msgExtendLockup = OsmosisLockupTypes._(
  ...
  static const OsmosisLockupTypes moduleBalanceResponse = OsmosisLockupTypes._(
    "/osmosis.lockup.ModuleBalanceResponse",
  );
  static const OsmosisLockupTypes moduleLockedAmountRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.ModuleLockedAmountRequest",
  ...
  static const OsmosisLockupTypes accountUnlockableCoinsRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.AccountUnlockableCoinsRequest",
  ...
  static const OsmosisLockupTypes accountUnlockingCoinsRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.AccountUnlockingCoinsRequest",
  ...
  static const OsmosisLockupTypes accountLockedPastTimeRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.AccountLockedPastTimeRequest",
  ...
  accountLockedPastTimeNotUnlockingOnlyRequest = OsmosisLockupTypes._(
  ...
  static const OsmosisLockupTypes accountUnlockedBeforeTimeRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.AccountUnlockedBeforeTimeRequest",
  ...
  static const OsmosisLockupTypes accountLockedPastTimeDenomRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.AccountLockedPastTimeDenomRequest",
  ...
  static const OsmosisLockupTypes lockedDenomResponse = OsmosisLockupTypes._(
  ...
  static const OsmosisLockupTypes lockedResponse = OsmosisLockupTypes._(
    "/osmosis.lockup.LockedResponse",
  );
  static const OsmosisLockupTypes syntheticLockupsByLockupIDRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.SyntheticLockupsByLockupIDRequest",
  ...
  static const OsmosisLockupTypes accountLockedDurationRequest =
      OsmosisLockupTypes._(
        "/osmosis.lockup.AccountLockedDurationRequest",
  ...
  accountLockedLongerDurationNotUnlockingOnlyRequest = OsmosisLockupTypes._(
    ...
    query: "/osmosis.lockup.Query/AccountLockedLongerDurationNotUnlockingOnly",
    rpc:
        "/osmosis/lockup/v1beta1/account_locked_longer_duration_not_unlocking_only/:owner",
  );
  static const OsmosisLockupTypes
  accountLockedLongerDurationNotUnlockingOnlyResponse = OsmosisLockupTypes._(
  ...
  static const OsmosisLockupTypes
  accountLockedLongerDurationDenomRequest = OsmosisLockupTypes._(
    "/osmosis.lockup.AccountLockedLongerDurationDenomRequest",
    query: "/osmosis.lockup.Query/AccountLockedLongerDurationDenom",
    rpc: "/osmosis/lockup/v1beta1/account_locked_longer_duration_denom/:owner",
  );
