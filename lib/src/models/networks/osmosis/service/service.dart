...
abstract class OsmosisService<T extends CosmosMessage>
  ...
  static T? fromJson<T extends OsmosisService>({
    ...
    final OsmosisService? service = switch (root) {
      ...
      OsmosisCosmWasmPoolV1beta1Types.root => OsmosisWasmPoolV1Beta1.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      ...
      OsmosisGammV1beta1Types.root => OsmosisGammV1Beta1.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisIbchooksTypes.root => OsmosisIbchooks.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisIncentivesTypes.root => OsmosisIncentives.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisLockupTypes.root => OsmosisLockup.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisPoolManagerV1beta1Types.root => OsmosisPoolManagerV1Beta1.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisProtorevV1beta1Types.root => OsmosisProtorevV1Beta1.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisStreamSwapV1Types.root => OsmosisStreamSwapV1.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      OsmosisSuperfluidTypes.root => OsmosisSuperfluid.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      ...
      OsmosisValSetprefV1beta1Types.root => OsmosisValSetprefV1Beta1.fromJson(
        typeUrl: typeUrl,
        json: json,
      ),
      _ => null,
  ...
  static T? deserialize<T extends ServiceMessage>({
    ...
    final ServiceMessage? service = switch (root) {
      ...
      OsmosisGammV1beta1Types.root => OsmosisGammV1Beta1.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisIbchooksTypes.root => OsmosisIbchooks.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisIncentivesTypes.root => OsmosisIncentives.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisLockupTypes.root => OsmosisLockup.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisPoolManagerV1beta1Types.root =>
        OsmosisPoolManagerV1Beta1.deserialize(typeUrl: typeUrl, bytes: bytes),
      OsmosisProtorevV1beta1Types.root => OsmosisProtorevV1Beta1.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisStreamSwapV1Types.root => OsmosisStreamSwapV1.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisSuperfluidTypes.root => OsmosisSuperfluid.deserialize(
        typeUrl: typeUrl,
        bytes: bytes,
      ),
      OsmosisTokenFactoryV1beta1Types.root =>
