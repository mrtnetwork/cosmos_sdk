...
class OsmosisDowntimeDetectorV1beta1Types extends TypeUrl {
  const OsmosisDowntimeDetectorV1beta1Types._(
    super.typeUrl, {
    super.query,
    super.rpc,
  });
  ...
  recoveredSinceDowntimeOfLengthRequest = OsmosisDowntimeDetectorV1beta1Types._(
    ...
    rpc: "/osmosis/downtime-detector/v1beta1/RecoveredSinceDowntimeOfLength",
  );
  static const OsmosisDowntimeDetectorV1beta1Types
  recoveredSinceDowntimeOfLengthResponse = OsmosisDowntimeDetectorV1beta1Types._(
