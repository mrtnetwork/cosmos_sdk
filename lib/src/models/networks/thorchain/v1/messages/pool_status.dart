...
class ThorchainPoolStatus implements CosmosEnum {
  ...
  static const ThorchainPoolStatus unknownPoolStatus =
      ThorchainPoolStatus._(0, "UnknownPoolStatus");
  static const ThorchainPoolStatus available =
      ThorchainPoolStatus._(1, "Available");
  static const ThorchainPoolStatus staged = ThorchainPoolStatus._(2, "Staged");
  static const ThorchainPoolStatus suspended =
      ThorchainPoolStatus._(3, "Suspended");
