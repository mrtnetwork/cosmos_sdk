...
class ThorchainKeygenType implements CosmosEnum {
  ...
  static const ThorchainKeygenType unknownKeygen = ThorchainKeygenType._(
    "UnknownKeygen",
    0,
  );
  static const ThorchainKeygenType asgardKeygen = ThorchainKeygenType._(
    "AsgardKeygen",
    1,
  );
  static const ThorchainKeygenType yggdrasilKeygen = ThorchainKeygenType._(
    "YggdrasilKeygen",
    2,
  );
