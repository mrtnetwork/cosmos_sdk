...
class ThorchainNodeType implements CosmosEnum {
  ...
  static const ThorchainNodeType typeValidator =
      ThorchainNodeType._(0, "TypeValidator");
  static const ThorchainNodeType typeVault =
      ThorchainNodeType._(1, "TypeVault");
  static const ThorchainNodeType typeUnknown =
      ThorchainNodeType._(2, "TypeUnknown");
