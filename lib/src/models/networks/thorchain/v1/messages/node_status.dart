...
class ThorchainNodeStatus implements CosmosEnum {
  ...
  static const ThorchainNodeStatus unknown = ThorchainNodeStatus._(
    0,
    "Unknown",
  );
  static const ThorchainNodeStatus whitelisted = ThorchainNodeStatus._(
    1,
    "Whitelisted",
  );
  static const ThorchainNodeStatus standby = ThorchainNodeStatus._(
    2,
    "Standby",
  );
  ...
  static const ThorchainNodeStatus disabled = ThorchainNodeStatus._(
    5,
    "Disabled",
  );
