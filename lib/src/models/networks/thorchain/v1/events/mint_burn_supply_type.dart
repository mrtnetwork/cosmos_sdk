...
class ThorchainMintBurnSupplyType implements CosmosEnum {
  ...
  static const ThorchainMintBurnSupplyType mint = ThorchainMintBurnSupplyType._(
    0,
    "mint",
  );
  static const ThorchainMintBurnSupplyType burn = ThorchainMintBurnSupplyType._(
    1,
    "burn",
  );
