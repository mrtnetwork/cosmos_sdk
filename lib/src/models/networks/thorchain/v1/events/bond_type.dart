...
class ThorchainBondType implements CosmosEnum {
  ...
  static const ThorchainBondType bondReturned =
      ThorchainBondType._(1, "bondReturned");
  static const ThorchainBondType bondReward =
      ThorchainBondType._(2, "bondReward");
