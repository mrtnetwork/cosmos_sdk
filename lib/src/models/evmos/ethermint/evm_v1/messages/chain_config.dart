...
class EvmosEthermintEVMV1ChainConfig extends CosmosMessage {
  ...
  factory EvmosEthermintEVMV1ChainConfig.fromJson(Map<String, dynamic> json) {
  ...
  @override
  TypeUrl get typeUrl => EvmosErc20V1Types.chainConfig;
