...
/// ConsensusState defines a solo machine consensus state. The sequence of a consensus state is
/// contained in the "height" key used in storing the consensus state.
class IbcSoloMachineV2ConsensusState extends CosmosMessage {
  ...
  @override
  String get typeUrl => IbcTypes.soloMachineV2ConsensusState.typeUrl;
