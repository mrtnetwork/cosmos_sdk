...
abstract class IbcService<T extends CosmosMessage> extends ServiceMessage<T> {
  ...
  static T? fromJson<T extends ServiceMessage>({
    ...
    final ServiceMessage? service =
        switch (type) {
              IbcTypes.msgPayPacketFeeAsync => MsgPayPacketFeeAsync.fromJson(
                json,
              ),
              ...
              IbcTypes.msgChannelCloseConfirm =>
                MsgChannelCloseConfirm.fromJson(json),
              IbcTypes.msgChannelCloseInit => MsgChannelCloseInit.fromJson(
                json,
              ),
              IbcTypes.msgChannelOpenAck => MsgChannelOpenAck.fromJson(json),
              IbcTypes.msgChannelOpenConfirm => MsgChannelOpenConfirm.fromJson(
                json,
              ),
              IbcTypes.msgChannelOpenInit => MsgChannelOpenInit.fromJson(json),
              IbcTypes.msgChannelOpenTry => MsgChannelOpenTry.fromJson(json),
              IbcTypes.msgChannelUpgradeAck => MsgChannelUpgradeAck.fromJson(
                json,
              ),
              ...
              IbcTypes.msgChannelUpgradeInit => MsgChannelUpgradeInit.fromJson(
                json,
              ),
              IbcTypes.msgChannelUpgradeOpen => MsgChannelUpgradeOpen.fromJson(
                json,
              ),
              IbcTypes.msgChannelUpgradeTimeout =>
                MsgChannelUpgradeTimeout.fromJson(json),
              IbcTypes.msgChannelUpgradeTry => MsgChannelUpgradeTry.fromJson(
                json,
              ),
              ...
              IbcTypes.channelV2MsgTimeout => IbcChannelV2MsgTimeout.fromJson(
                json,
              ),
              IbcTypes.msgCreateClient => MsgCreateClient.fromJson(json),
              IbcTypes.msgIBCSoftwareUpgrade => MsgIBCSoftwareUpgrade.fromJson(
                json,
              ),
              IbcTypes.msgRecoverClient => MsgRecoverClient.fromJson(json),
              IbcTypes.msgUpdateClient => MsgUpdateClient.fromJson(json),
              IbcTypes.msgUpdateParams => IbcClientMsgUpdateParams.fromJson(
                json,
              ),
  ...
  static T? deserialize<T extends ServiceMessage>({
    ...
    final ServiceMessage? service =
        switch (type) {
              IbcTypes.msgPayPacketFeeAsync => MsgPayPacketFeeAsync.deserialize(
                bytes,
              ),
              ...
              ///
              IbcTypes.msgAcknowledgement => MsgAcknowledgement.deserialize(
                bytes,
              ),
              IbcTypes.msgChannelCloseConfirm =>
                MsgChannelCloseConfirm.deserialize(bytes),
              IbcTypes.msgChannelCloseInit => MsgChannelCloseInit.deserialize(
                bytes,
              ),
              IbcTypes.msgChannelOpenAck => MsgChannelOpenAck.deserialize(
                bytes,
              ),
              IbcTypes.msgChannelOpenConfirm =>
                MsgChannelOpenConfirm.deserialize(bytes),
              IbcTypes.msgChannelOpenInit => MsgChannelOpenInit.deserialize(
                bytes,
              ),
              IbcTypes.msgChannelOpenTry => MsgChannelOpenTry.deserialize(
                bytes,
              ),
              IbcTypes.msgChannelUpgradeAck => MsgChannelUpgradeAck.deserialize(
                bytes,
              ),
              IbcTypes.msgChannelUpgradeCancel =>
              ...
              IbcTypes.msgChannelUpgradeTry => MsgChannelUpgradeTry.deserialize(
                bytes,
              ),
              IbcTypes.msgPruneAcknowledgements =>
                MsgPruneAcknowledgements.deserialize(bytes),
              IbcTypes.msgRecvPacket => MsgRecvPacket.deserialize(bytes),
              IbcTypes.msgTimeoutOnClose => MsgTimeoutOnClose.deserialize(
                bytes,
              ),
              ...
              IbcTypes.msgUpdateParams => IbcClientMsgUpdateParams.deserialize(
                bytes,
              ),
