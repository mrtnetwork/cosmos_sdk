...
class AminoTx {
  ...
  AminoTx copyWith({
    ...
    assert(
        accountNumber == null || !accountNumber.isNegative, "invalid sequence");
    return AminoTx(
  ...
  factory AminoTx.fromJson(Map<String, dynamic> json) {
    ...
    final List<Map<String, dynamic>> msgs = json.asListOfMap(
      "msgs",
      throwOnNull: true,
      onError: (notfound) {
        if (notfound) {
          return const AminoJsonParserException("Missing 'msgs' parameters.");
        }
        return const AminoJsonParserException(
