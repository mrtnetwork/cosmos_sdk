...
class StrideTypes extends TypeUrl {
  ...
  static const StrideTypes baseVestingAccount = StrideTypes._(
    "/stride.vesting.BaseVestingAccount",
  );
  static const StrideTypes stridePeriodicVestingAccount = StrideTypes._(
