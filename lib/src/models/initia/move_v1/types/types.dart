...
class InitiaMoveV1Types extends TypeUrl {
  ...
  static const InitiaMoveV1Types msgExecute = InitiaMoveV1Types._(
    "/initia.move.v1.MsgExecute",
  );

  static const InitiaMoveV1Types msgExecuteResponse = InitiaMoveV1Types._(
    "/initia.move.v1.MsgExecuteResponse",
  );
  static const List<InitiaMoveV1Types> values = [msgExecute];
