...
class CosmWasmV1AccessType implements CosmosEnum {
  ...
  static const CosmWasmV1AccessType unspecified = CosmWasmV1AccessType._(
    0,
    "ACCESS_TYPE_UNSPECIFIED",
  );

  /// AccessTypeNobody forbidden
  static const CosmWasmV1AccessType noBody = CosmWasmV1AccessType._(
    1,
    "ACCESS_TYPE_NOBODY",
  );

  /// AccessTypeEverybody unrestricted
  static const CosmWasmV1AccessType everyBody = CosmWasmV1AccessType._(
    3,
    "ACCESS_TYPE_EVERYBODY",
  );

  /// AccessTypeAnyOfAddresses allow any of the addresses
  static const CosmWasmV1AccessType anyOfAddress = CosmWasmV1AccessType._(
    4,
