  ...
  static T? fromJson<T extends CosmWasm1Beta1Service>({
    ...
    final CosmWasm1Beta1Service? service =
        switch (type) {
              ...
              CosmWasmV1Types.msgStoreCode => CosmWasmV1StoreCode.fromJson(
                json,
              ),
              CosmWasmV1Types.msgSudoContract =>
                CosmWasmV1SudoContract.fromJson(json),
              CosmWasmV1Types.msgUnpinCodes => CosmWasmV1UnPinCodes.fromJson(
                json,
              ),
              CosmWasmV1Types.msgUpdateAdmin => CosmWasmV1UpdateAdmin.fromJson(
                json,
              ),
              ...
              CosmWasmV1Types.msgUpdateParams =>
                CosmWasmV1UpdateParams.fromJson(json),
              _ => null,
            }
  ...
  static T? deserialize<T extends ServiceMessage>({
    ...
    final ServiceMessage? service =
        switch (type) {
              ...
              CosmWasmV1Types.msgClearAdmin => CosmWasmV1ClearAdmin.deserialize(
                bytes,
              ),
              CosmWasmV1Types.msgExecuteContract =>
              ...
              CosmWasmV1Types.msgPinCodes => CosmWasmV1PinCodes.deserialize(
                bytes,
              ),
              CosmWasmV1Types.msgRemoveCodeUploadParamsAddresses =>
              ...
              CosmWasmV1Types.msgStoreCode => CosmWasmV1StoreCode.deserialize(
                bytes,
              ),
              CosmWasmV1Types.msgSudoContract =>
                CosmWasmV1SudoContract.deserialize(bytes),
              CosmWasmV1Types.msgUnpinCodes => CosmWasmV1UnPinCodes.deserialize(
                bytes,
              ),
