...
abstract class CCTPV1Service<T extends CosmosMessage>
  ...
  static T? fromJson<T extends ServiceMessage>({
    ...
    final ServiceMessage? service =
        switch (type) {
              ...
              CCTPV1Types.msgUpdatePauser => CCTPV1MsgUpdatePauser.fromJson(
                json,
              ),
              ...
              CCTPV1Types.msgReplaceMessage => CCTPV1MsgReplaceMessage.fromJson(
                json,
              ),
              CCTPV1Types.msgRemoveRemoteTokenMessenger =>
                CCTPV1MsgRemoveRemoteTokenMessenger.fromJson(json),
              CCTPV1Types.msgDepositForBurn => CCTPV1MsgDepositForBurn.fromJson(
                json,
              ),
              ...
              CCTPV1Types.msgDisableAttester =>
                CCTPV1MsgDisableAttester.fromJson(json),
              CCTPV1Types.msgEnableAttester => CCTPV1MsgEnableAttester.fromJson(
                json,
              ),
              CCTPV1Types.msgLinkTokenPair => CCTPV1MsgLinkTokenPair.fromJson(
                json,
              ),
              CCTPV1Types.msgUnlinkTokenPair =>
                CCTPV1MsgUnlinkTokenPair.fromJson(json),
              CCTPV1Types.msgReceiveMessage => CCTPV1MsgReceiveMessage.fromJson(
                json,
              ),
              _ => null,
            }
  ...
  static T? deserialize<T extends ServiceMessage>({
    ...
    final ServiceMessage? service =
        switch (type) {
              CCTPV1Types.msgAcceptOwner => CCTPV1MsgAcceptOwner.deserialize(
                bytes,
              ),
              CCTPV1Types.msgUpdateOwner => CCTPV1MsgUpdateOwner.deserialize(
                bytes,
              ),
              CCTPV1Types.msgUpdatePauser => CCTPV1MsgUpdatePauser.deserialize(
                bytes,
              ),
              CCTPV1Types.msgUpdateSignatureThreshold =>
              ...
              CCTPV1Types.msgSendMessage => CCTPV1MsgSendMessage.deserialize(
                bytes,
              ),
              CCTPV1Types.msgSendMessageWithCaller =>
              ...
              CCTPV1Types.msgLinkTokenPair =>
                CCTPV1MsgLinkTokenPair.deserialize(bytes),
              CCTPV1Types.msgUnlinkTokenPair =>
