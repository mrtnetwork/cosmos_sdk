class ThorNodeMethods {
  ...
  static const ThorNodeMethods assetPool = ThorNodeMethods._(
      "Returns the pool information for the provided asset.", "/pool/:asset");
  static const ThorNodeMethods pools = ThorNodeMethods._(
      "Returns the pool information for all assets.", "/pools");
  ...
  static const ThorNodeMethods dpools = ThorNodeMethods._(
      "Returns the pool information for all derived assets.", "/dpools");
  ...
  static const ThorNodeMethods savers = ThorNodeMethods._(
      "Returns all savers for the savers pool.", "/pool/:asset/savers");
  ...
  static const ThorNodeMethods borrowers = ThorNodeMethods._(
      "Returns all borrowers for the given pool.", "/pool/:asset/borrowers");
  ...
  static const ThorNodeMethods getTransactionSigner = ThorNodeMethods._(
      "Deprecated - migrate to /tx/details.", "/tx/:hash/signers");
  ...
  static const ThorNodeMethods getTransactionStatus = ThorNodeMethods._(
      "Returns the status of a provided inbound hash.", "/tx/status/:hash");
  ...
  static const ThorNodeMethods nodes = ThorNodeMethods._(
      "Returns node information for all registered validators.", "/nodes");

  static const ThorNodeMethods asgard =
      ThorNodeMethods._("Returns current asgard vaults.", "/vaults/asgard");
  static const ThorNodeMethods yggdrasil = ThorNodeMethods._(
      "Returns current yggdrasil vaults.", "/vaults/yggdrasil");
  static const ThorNodeMethods getPubkeyVault = ThorNodeMethods._(
      "Returns the vault for the provided pubkey.", "/vault/:pubkey");
  static const ThorNodeMethods getPubkeysVault = ThorNodeMethods._(
      "Returns all pubkeys for current vaults.", "/vaults/pubkeys");

  static const ThorNodeMethods network =
      ThorNodeMethods._("Returns network overview statistics.", "/network");
  ...
  static const ThorNodeMethods lastblock = ThorNodeMethods._(
      "Returns the last block information for all chains.", "/lastblock");
  ...
  static const ThorNodeMethods ban = ThorNodeMethods._(
      "Returns the ban status for the provided node address.", "/ban/:address");
  static const ThorNodeMethods pool = ThorNodeMethods._(
      "Returns protocol owned liquidity overview statistics.", "/pol");
  static const ThorNodeMethods streamingState = ThorNodeMethods._(
      "Returns the state of a streaming swap", "/swap/streaming/:hash");
  static const ThorNodeMethods streamingStates = ThorNodeMethods._(
      "Returns the state of all streaming swaps", "/swaps/streaming");
  static const ThorNodeMethods cloutScore = ThorNodeMethods._(
      "Returns the clout score of an address", "/clout/swap/:address");
  ...
  static const ThorNodeMethods tradeUnits = ThorNodeMethods._(
      "Returns the total units and depth of a trade asset", "/trade/units");
  ...
  static const ThorNodeMethods tradeAccounts = ThorNodeMethods._(
      "Returns all trade accounts for an asset", "/trade/accounts/:asset");
  static const ThorNodeMethods queue =
      ThorNodeMethods._("Returns queue statistics", "/queue");
  static const ThorNodeMethods swap =
      ThorNodeMethods._("Returns the swap queue", "/queue/swap");
  static const ThorNodeMethods scheduled =
      ThorNodeMethods._("Returns the scheduled queue", "/queue/scheduled");
  ...
  static const ThorNodeMethods metrics = ThorNodeMethods._(
      "Returns keygen and keysign metrics for current vaults.", "/metrics");
  ...
  static const ThorNodeMethods mimir = ThorNodeMethods._(
      "Returns current active mimir configuration.", "/mimir");
  ...
  static const ThorNodeMethods mirmirAdmin = ThorNodeMethods._(
      "Returns current admin mimir configuration.", "/mimir/admin");
  static const ThorNodeMethods mirmirnodesAll = ThorNodeMethods._(
      "Returns current node mimir votes.", "/mimir/nodes_all");
  static const ThorNodeMethods mirmirNodeAddress = ThorNodeMethods._(
      ...
      "/mimir/node/:address");
  static const ThorNodeMethods mirmirV2 =
      ThorNodeMethods._("Returns current mimir V2 configuration", "/mimirV2");
  ...
  static const ThorNodeMethods invariants = ThorNodeMethods._(
      "Returns a list of available invariants.", "/invariants");
  static const ThorNodeMethods block =
      ThorNodeMethods._("Returns verbose details of the block.", "/block");
}
